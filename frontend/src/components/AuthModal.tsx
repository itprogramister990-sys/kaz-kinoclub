    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md p-8 rounded-3xl backdrop-blur-xl bg-slate-950/60 border border-slate-700/50 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
        ...
        <form onSubmit={handleCredentialsLogin} className="space-y-4 mb-6">
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold shadow-lg hover:shadow-blue-500/25 transition-all transform hover:scale-[1.02]"
          >
            Войти
          </button>
        </form>
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 py-3 rounded-xl bg-white text-slate-900 hover:bg-slate-100 font-medium transition-all transform hover:scale-[1.02] shadow-md"
        >
